...
const en: Dict = {
  ...
  "menu.showingFor": "Showing menu for",
  // food card
  "card.save": "Save",
  "card.min": "min",
  "card.cal": "cal",
  ...
  // food detail page
  "food.notFound": "Dish not found",
  "food.backToMenu": "Back to menu",
  "food.ingredients": "Ingredients",
  "food.decrease": "Decrease",
  "food.increase": "Increase",
  "food.add": "Add",
  "food.toBag": "to bag",
  "food.spice.0": "Mild",
  "food.spice.1": "Medium",
  ...
  "food.spice.3": "Fire",
  // language
  "promo.title": "Special offer! 15% off your first order",
  "promo.cta": "Order now",
  "promo.close": "Close",
  "lang.switch": "العربية",
};
...
const ar: Dict = {
  ...
  "food.notFound": "الصنف غير موجود",
  "food.backToMenu": "الرجوع للمنيو",
  "food.ingredients": "المكوّنات",
  "food.decrease": "إنقاص",
  "food.increase": "زيادة",
  "food.add": "أضف",
  "food.toBag": "للسلة",
  ...
  "food.spice.2": "حار",
  "food.spice.3": "ناري",
  "promo.title": "عرض خاص! خصم 15% على أول طلب",
  "promo.cta": "اطلب الآن",
  "promo.close": "إغلاق",
  "lang.switch": "English",
};
